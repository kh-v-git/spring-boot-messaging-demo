...
@Component
@Profile("activemq")
public class ActiveMqMessageConsumerServiceImpl implements MessageConsumerService {

    @JmsListener(destination = "${application.message.queue.create-event-queue}")
    @Override
    ...
    @JmsListener(destination = "${application.message.queue.update-event-queue}")
    @Override
    ...
    @JmsListener(destination = "${application.message.queue.delete-event-queue}")
    @Override
